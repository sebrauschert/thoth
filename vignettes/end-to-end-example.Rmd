...
This vignette provides a complete end-to-end example of using `thoth` with the classic iris dataset. We'll cover:
...
- Set up a complete analytics project with `thoth`
